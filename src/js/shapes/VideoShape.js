...
mxShapeMockupVideoPlayer.prototype.paintVertexShape = function (c, x, y, w, h) {
    ...
    var buttonColor = mxUtils.getValue(this.style, mxShapeMockupVideoPlayer.prototype.cst.FILL_COLOR2, 'grey');
    var frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'grey');
    var filledColor = mxUtils.getValue(this.style, mxShapeMockupVideoPlayer.prototype.cst.STROKE_COLOR2, 'grey');
    var emptyColor = mxUtils.getValue(this.style, mxShapeMockupVideoPlayer.prototype.cst.STROKE_COLOR3, 'grey');
...
mxShapeMockupVideoPlayer.prototype.otherShapes = function (c, x, y, w, h, buttonColor, frameColor, filledColor, emptyColor, barHeight) {
    ...
    var textColor = mxUtils.getValue(this.style, mxShapeMockupVideoPlayer.prototype.cst.TEXT_COLOR, 'grey');
    c.begin();
...
export default mxShapeMockupVideoPlayer;