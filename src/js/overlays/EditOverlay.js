...
function EditOverlay(imageURL, cursor){
    mxCellOverlay.call(this, new mxImage(CONST.IMAGES.FLASH || imageURL, CONST.TAG.SIZE, CONST.TAG.SIZE), 'Edit Attributes', mxConstants.ALIGN_LEFT, mxConstants.ALIGN_BOTTOM, new mxPoint(-15, -5), cursor);
